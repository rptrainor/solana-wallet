...
const Menu = () => {
  const { value, send } = useSolanaWallet();
  ...
  return (
    <div className="flex flex-row sm:flex-col items-center justify-end sm:justify-start gap-4">
      ...
      {(value === "CONNECTED" || value === "SENDING_TRANSACTION" || value === "TRANSACTION_SENT") && (<Button type="button" onClick={() => send({ type: "DISCONNECT" })}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 640 512"
      ...
      {value !== "ERROR" && value !== "DISCONNECTED" && value !== "CONNECTING" && (<Button
        type="button"
